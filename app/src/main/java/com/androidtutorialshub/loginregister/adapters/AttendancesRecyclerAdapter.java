...
public class AttendancesRecyclerAdapter extends RecyclerView.Adapter<AttendancesRecyclerAdapter.AttendanceViewHolder> {
    ...
    public void onBindViewHolder(AttendanceViewHolder holder, int position) {
        holder.textViewEID.setText(Integer.toString(listAttendances.get(position).getEventID()));
        holder.textViewMID.setText(Integer.toString(listAttendances.get(position).getMemID()));
        holder.textViewNID.setText(Integer.toString(listAttendances.get(position).getNmID()));
    }
