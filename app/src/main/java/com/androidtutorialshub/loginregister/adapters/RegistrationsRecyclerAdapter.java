...
public class RegistrationsRecyclerAdapter extends RecyclerView.Adapter<RegistrationsRecyclerAdapter.RegistrationViewHolder> {
    ...
    public void onBindViewHolder(RegistrationViewHolder holder, int position) {
        holder.textViewEID.setText(Integer.toString(listRegistrations.get(position).getEventID()));
        holder.textViewMID.setText(Integer.toString(listRegistrations.get(position).getMemID()));
        holder.textViewNID.setText(Integer.toString(listRegistrations.get(position).getNmID()));
    }
