...
public class FillNonMember extends AppCompatActivity implements View.OnClickListener{
    ...
    private TextInputLayout textInputLayoutNMID1;
    ...
    private TextInputEditText textInputEditTextNMID1;
    ...
    */
    ...
    private void initViews() {
        ...
        textInputLayoutNMID1 = (TextInputLayout) findViewById(R.id.textInputLayoutNMID3);
        ...
        textInputEditTextNMID1 = (TextInputEditText) findViewById(R.id.textInputEditTextNMID3);


        appCompatButtonViewNonMember = (AppCompatButton) findViewById(R.id.appCompatButtonViewNonMember);
        appCompatTextViewLoginLink = (AppCompatTextView) findViewById(R.id.appCompatTextViewNonMember);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.appCompatButtonViewNonMember:
                ...
                break;
            case R.id.appCompatTextViewNonMember:
                Intent accountsIntentNonMem = new Intent(getApplicationContext(), ViewNonMember.class);
                startActivity(accountsIntentNonMem);
                break;
    ...
    private void addNonMemberToSQLite() {
        ...
        //databaseHelper.getWritableDatabase().execSQL("insert into non_member values(145,'ghasd','asdf','7458634')");


                databaseHelper.getWritableDatabase().execSQL("insert into non_member (nmID,name,email,mobile) values ("+
                Integer.parseInt(textInputEditTextNMID1.getText().toString().trim())
