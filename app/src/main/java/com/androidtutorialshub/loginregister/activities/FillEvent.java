...
public class FillEvent extends AppCompatActivity implements View.OnClickListener{
    ...
    */
    ...
    private void initViews() {
        ...
        textInputLayoutEID = (TextInputLayout) findViewById(R.id.textInputLayoutEID99);
        ...
        textInputEditTextEID = (TextInputEditText) findViewById(R.id.textInputEditTextEID99);



        appCompatButtonViewEvent = (AppCompatButton) findViewById(R.id.appCompatButtonViewEvent);
        appCompatTextViewEventLink = (AppCompatTextView) findViewById(R.id.appCompatTextViewEvent);
    ...
    private void initListeners() {
        ...
        appCompatTextViewEventLink.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.appCompatButtonViewEvent:
                if ("Tech Web Dev Design".indexOf(textInputEditTextEType.getText().toString().trim())==-1) {
            ...
            case R.id.appCompatTextViewEvent:
    ...
    private void addEventToSQLite() {
        ...
        if (!inputValidation.isInputEditTextFilled(textInputEditTextEType, textInputLayoutEType, "Enter Event Type")) {
            return;
        }
        if (!inputValidation.isInputEditTextFilled(textInputEditTextEVenue, textInputLayoutEVenue, "Enter Event Venue")) {
            return;
        }
        ...
        databaseHelper.getWritableDatabase().execSQL("insert into event (eventID,name,venue,type) values ("+
